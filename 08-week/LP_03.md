...
> 📌 Your goal with this section is to give an *introduction* to typography. It won't be in-depth—you'll be covering typography quickly. This lecture, in addition to the next lecture on type, prepares students to achieve today's first learning objective: selecting and working with primary and secondary font types from Google Fonts and Figma/Adobe XD type styles.

Call class to attention.

With this lecture, you're opening students' eyes to the smallest unit of design: type. This will be an "aha" moment for most of your students. They've been around type, but never considered *why* no two type families are alike—and why designers spend hours and hours laboring over decisions about type. In fact, some professionals spend their entire careers on typography. It's a massive, specialized topic that we will move through quickly—so stay focused.

:gem: **Designer Insight:** UX/UI designers spend time collecting reference materials for type as well as general UI inspiration. Share your own inspiration, research habits, and routines.
...
- Typography is 90% of a webpage.
  ...
  - Every UI decision starts with considering your user!

- Review typography jargon.
...
- Review a font versus a typeface/font family to match the slides.

- Typography is essential to communicating effectively.
...
Students should now have a general appreciation for how type occupies space and its importance as a design element. Let's move into how type is officially classified.

## 3. Instructor Do: Typography Classifications (5 min)

> 📌 Your goal is to continue with the typography overview and teach type classifications. This lecture continues preparing students to execute the first learning objective: selecting and working with primary and secondary font types and Google Fonts.

You'll help students better understand how type is classified, which will help them communicate with colleagues on design teams.

**Say:** "Typography has a voice."

To demonstrate the "voice" that type has, role-play the following with your class or TAs:
...
### Review the Typography Classifications Tool Snapshot
...
:gem: **Student Insight:** Invite student input. Because there are a lot of type nerds out there.

- **Ask:** "*Anyone consider themselves a type nerd?*"

- **Ask:** "What is your favorite typeface?"

- Having a favorite typeface is a sign one is a type nerd.
  
- Typography is a deep design vein, but it starts with serif and sans serif typefaces.

- Review the Vox-ATypI typography classification method.
...
## UX Type Versus UI Type

- Review the following:

  - UX type versus UI type
  - Wireframe versus design comp
...
:briefcase: **Employer Competitive Note:** Typography choices should apply to more than just your clients' projects. Choose great fonts for your resume and your personal website portfolios that match and are used consistently.

Now that students have *heard* about type, *show* them with a demo of one resource that designers turn to when working with type: Google Fonts.

## 4. Instructor Do: Demo - Google Fonts (5 min)

> :pushpin: Your goal is to demo Google Fonts to prepare students for downloading the fonts themselves. This is also part of the first learning objective: selecting and working with primary and secondary font types and Google Fonts.

You've done a lot of talking—time to show students more examples of what you're talking about. Specifically, you're going to show them Google Fonts, which will prepare them for the hands-on activity that follows.
...
## 7. Instructor Do: Typography Tips (10 min)

> 📌 The goal is to share eight typography tips with students. By doing so, you complete your overview of type and fulfill their ability to achieve the first learning objective: selecting and working with primary and secondary font types and Google Fonts.

Call class back to attention. This is your last lecture on type, which serves as a checklist students can use to make type decisions.

The goal is to give students a broad overview of typography so that they can dive deeper independently and practice these design concepts. **Students can, and should, dig deeper into typography on their own time.**
...
**Ask a TA or a student to read Zapf's quote aloud:** "Typography is a two-dimensional architecture based on experience and imagination and guided by rules and readability. And this is the purpose of typography: the arrangement of design elements within a given structure should allow the reader to easily focus on the message without slowing down the speed of his reading.""

These are the best practices designers use when working with type.

### Typography Tips

- Review the eight typography tips.

  - If students are not familiar with the following tips, encourage them to research more in-depth at home.

:gem: **Designer Insight:** Share what design teams talk about when they talk about typography in the real world.
...
1. Two to three font families max:

   - Too many fonts send a mixed message.

2. Type contrast and color contrast:

   - Color and type work together. They should establish a clear hierarchy.

3. F reading pattern:

   - Discuss heat maps through user testing and how in English we read left to right and top to bottom.

4. Z eye flow:

   - Reading versus UI actions.
...
6. Type spacing and white space:
   ...
   - White space calms us, letting us “breathe.”
...
- Reviewing these design tips is A LOT to do quickly, but you'll have a chance to work with UI type for the rest of your boot camp and your UX/UI careers. Continue to internalize these ideas and find their uses out in the wild.

Now that students have a list of tips to keep on hand, it's time for them to get more hands-on practice with typeface. With the following activity, they're gaining valuable training in two ways: **(1) applying type to a mock webpage** and **(2) working in Figma/Adobe XD.**
...
After a break, you'll dive into an overview of UI grids.

## 10. Break (15 min)

Take a quick break.

After students return from the break, you'll start Part 2 of today's lesson on UI grids.

🌐 **Online Recommendation:** Don't stop sharing your screen. Put up a Google timer or a YouTube timer video to help get students back into the Zoom room on time.

## 11. Instructor Do: UI Grids and Grid Anatomy (10 min)

> :pushpin: Your goal is to help students achieve their second learning objective of the day: articulating the underlying logic and layout of a website as revealed by a UI grid.

Now that everyone has had a break, it's time to switch gears from type to objects.

You will now move from examining the way type occupies space to looking at how elements and objects on a page occupy space. Students are growing their ability to analyze design components. Ideally, they'll never look at a site or app the same way again.

> :gem: **Designer Insight**: Share with students how you made the shift from seeing objects to noticing how space is organized on a page.
>
> - Alternatively, ask a TA to share how their way of seeing objects on a page shifted as they became designers.

### Grids

Walk through the basics of a UI grid. This might feel rudimentary to some, but remind students that the best designers in the world take time to practice becoming experts at grids.

Discuss how a screen is made of pixels. A pixel is the smallest element that is itself a grid.
...
- Grids are everywhere.
  ...
  - Mention a grid that you were made aware of recently: a sidewalk, bathroom tile, or fabric. Grids are memorable.
...
Walk through the grid examples.

### Anatomy of a UI Grid

Walk through grid anatomy. 
...
Students have seen grids, so now it's time to work with grids to help students understand their value. The following activity walks students through overlaying a grid onto a familiar site—Apple.com.
...
## 13. Instructor Do: 12-Column Grids (5 min)

> 📌 The goal in this section is to help students think about the rules of a design layout and adopt the 12-column grid as a standard tool.

Let students know the 12-column grid is used regularly in the world, and they'll get a lot of practice with this type of grid.

- Review the popular 12-column grid.

  - Point out that grid systems require a little math, but help build logic into your UI pages.
...
At this point, students grasp how sites are designed using the 12-column grid. Next, build on that by showing them how Adobe XD is used to set up a 12-column layout. Following your demo, students will try it for themselves.
...
## 15. Instructor Do: Types of Grid Logic (5 min)

> 📌 The goal is to get students to think about and practice how grid logic defines a page layout. This supports the second and third learning objectives: articulating how UI grids help design and understanding the underlying logic and layout of a popular website revealed by applying a UI grid.

Students have a general sense of UI grids now, but it's very linear. Now they're ready to go deeper and understand *types* of grids. Once you review the four types of grid logic below, you can turn students loose on creating UI grids themselves.

Executing on a grid is a new skill for some students, so make sure to point out the grid logic in samples.
...
This wraps up the second section of today's lesson on UI grids. Students have seen grids and should now understand the *types* of UI grids. We're ready for part three of today's lesson on practicing using typography and grids together in desktop layouts.

:briefcase: **Employer Competitive Note:** Designers are expected to be experts with UI grids and responsive grid systems. These skills are highly visual but should be visual in your design process as well as listed on your resume.

Once students complete the two-part activity that follows, they'll have achieved their fourth learning objective: reproducing a webpage by applying UI principles and a UI grid.
